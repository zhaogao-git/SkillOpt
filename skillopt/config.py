...
_FLATTEN_MAP: dict[str, str] = {
    ...
    "model.copilot_cli_path": "copilot_cli_path",
    "model.copilot_cli_reasoning_effort": "copilot_cli_reasoning_effort",
    "model.copilot_cli_context": "copilot_cli_context",
    "model.copilot_cli_home": "copilot_cli_home",
    "model.copilot_cli_cwd": "copilot_cli_cwd",
    "model.copilot_cli_timeout_seconds": "copilot_cli_timeout_seconds",
